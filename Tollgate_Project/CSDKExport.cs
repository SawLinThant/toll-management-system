...
namespace Tollgate_Project
{
    ...
    {
        // Get last error
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_GetSDKLastError", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_GetSDKLastError();

        // Create screen
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_CreateScreen", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add program 
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddProgram", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add area
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddArea", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add image area item
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddImageAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add text area item
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddSimpleTextAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add time area item
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddTimeAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_CreateRealtimeArea", CallingConvention = CallingConvention.StdCall)]
        ...
        // Send command
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_SendCommand", CallingConvention = CallingConvention.StdCall)]
        ...
        // Send screen
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_SendScreen", CallingConvention = CallingConvention.StdCall)]
        ...
        // Send realtime area
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_SendRealTimeArea", CallingConvention = CallingConvention.StdCall)]
        ...
        // Get Color value
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_GetColor", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_GetColor(int r, int g, int b);

        // Save screen to disk
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_SaveScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_SaveScreen(IntPtr pDirPath);

        // command 
        // Get baudrate
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_GetBaudRate", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_GetBaudRate(int nPort, ref int pBaudRate, IntPtr pDeviceGUID);

        // Set baudrate
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_SetBaudRate", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_SetBaudRate(int nPort, int nSrcBaudRate, int nDestBaudRate, IntPtr pDeviceGUID);

        // Is card online
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_IsCardOnline", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_IsCardOnline(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // Clear screen
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_ClearScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_ClearScreen(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // Restart card
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_RestartCard", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_RestartCard(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // Test screen
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_TestScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_TestScreen(int nSendType, IntPtr pStrParams, int nStyle, IntPtr pDeviceGUID);

        // adjust time
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_AdjustTime", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_AdjustTime(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // set luminance
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_SetLuminance", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_SetLuminance(int nSendType, IntPtr pStrParams, int nLuminance, IntPtr pDeviceGUID);

        // screen ctrl
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_ScreenCtrl", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_ScreenCtrl(int nSendType, IntPtr pStrParams, int nCtrlCode, IntPtr pDeviceGUID);

        // timeswitch
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_TimeSwitch", CallingConvention = CallingConvention.StdCall)]
        ...
        // switch program
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_SwitchProgram", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_SwitchProgram(int nSendType, IntPtr pStrParams, int nProgramIndex, IntPtr pDeviceGUID);

        // Set ip
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_SetIP", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_Rt_SendScreen", CallingConvention = CallingConvention.StdCall)]
        ...
        // add realtimearea
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_Rt_AddRealAreaToScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_Rt_AddRealAreaToScreen(int nX, int nY, int nWidth, int nHeight, int nMaxPageCount);

        // send realtime text
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_Rt_SendRealTimeText", CallingConvention = CallingConvention.StdCall)]
        ...
        // send realtime image
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_Rt_SendRealTimeImage", CallingConvention = CallingConvention.StdCall)]
        ...
        // set screen params
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_SetScreenParam", CallingConvention = CallingConvention.StdCall)]
        ...
        // set program params
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_SetProgramParam", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddChineseCalendarAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddTempAndHumiAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // add count area item
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddCountAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // add digit area item
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Hd_AddDigitAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // clear realtime area
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_ClearRealtimeArea", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_ClearRealtimeArea(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // set digit state
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_SetDigitState", CallingConvention = CallingConvention.StdCall)]
        ...
        // set count state
        [DllImport(@"lib/HDSDK/HDSDK.dll", EntryPoint = "Cmd_SetCountState", CallingConvention = CallingConvention.StdCall)]
